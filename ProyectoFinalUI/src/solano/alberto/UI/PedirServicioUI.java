...
public class PedirServicioUI {
    ...
    public String verPedidos(){
        return "../HistorialPedidosUI.fxml";
    }
    ...
    public ObservableList<serviciosTabla> imprimirServicios() throws Exception {
        ...
        ArrayList<TreeMap<String, String>> listaServicios = objGestorSer.imprimirServiciosActivo();
    ...
    public String registrarPedido( ArrayList<TreeMap<String, String>> servicios, tarjetaTabla objTarjeta, direccionTabla objDireccion) throws Exception {
        try{
            return objGestorPe.registrarPedido(objCliente.getIdentificacion(), objCliente.getCorreo(), servicios, objDireccion.getProvincia(),
                    objDireccion.getCanton(), objDireccion.getDistrito(), objDireccion.getDireccionExacta(), objTarjeta.getNumero());
        }catch (Exception e){
            throw e;
        }
    }
